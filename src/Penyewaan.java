/**
 * Class Penyewaan.
 * Menyimpan data transaksi penyewaan, baik sewa lapangan maupun sewa peralatan.
 * Class ini berdiri sendiri (bukan bagian dari hierarki ItemSewa) karena
 * merepresentasikan "transaksi", bukan "barang/objek yang disewakan".
 */
